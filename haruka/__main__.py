...
Made from the source code of [ATOP 🇮🇳](t.me/ATOPBEGAR)

Special thanks to [this person](t.me/ATOPBEGAR) for helping me.

Deploy a bot like me [now](www.github.com/ZARUUUU/SAMER)
Watch [video tutorial](https://www.youtube.com/watch?v=gXXFpTAk6Vo&feature=youtu.be) on deploying me.

Click /help or Help button below to find out more about how to use me to my full potential.

 Add me to a group by clicking [here](http://t.me/Seker_robot?startgroup=true).
"""
